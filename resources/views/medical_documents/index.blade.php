...
.category-card.active .arrow-btn{
...
.category-card.active .doc-content{
    display:block;
}
.doc-grid{
    padding:24px;
...
<div class="doc-page">
    ...
    <div class="doc-header">
        <div>
            ...
            <p>Private encrypted medical reports, scans and prescriptions</p>
        </div>
    ...
    <div class="security-info">
        🔐 All uploaded documents are encrypted and stored privately. No direct public URL access is allowed.
    </div>
                        ...
                        @foreach($items as $document)
                            <div class="file-card">
                                ...
                                @if(!empty($document->file_size))
                                    <p>
                                        Size:
                                        @if(is_numeric($document->file_size))
                                ...
                                @if(empty($document->is_prescription_pdf))
                                    <div class="secure-badge">🔒 Encrypted Private File</div>
                                @endif
                                ...
                                <div class="actions">
                                    ...
                                    @else
                                        ...
                                        <form action="{{ route('medical-documents.destroy', $document->id) }}"
                                            ...
                                            <button type="submit"
                                                    onclick="return confirm('Delete this encrypted document?')"
